    ...
    <div className={"py-10 px-4 space-y-4"}>
      ...
      <div className={"space-y-1"}>
        ...
        <div className={"flex rounded-md shadow-sm"}>
                <span
                  className={"flex items-center justify-center px-3 rounded-l-md border border-r-0 border-gray-300 " +
                    "bg-gray-50 text-gray-500 select-none text-sm"}>+82</span>
          <input id={"input"}
                 className={"appearance-none w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm " +
                   "placeholder-gray-400 focus:outline-none focus:ring-orange-500 focus:border-orange-500 " +
                   "rounded-l-none"}
      ...
      <button
        className={"mt-5 w-full bg-orange-500 hover:bg-orange-600 text-white py-2 px-4 border border-transparent " +
