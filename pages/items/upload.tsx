...
const Upload: NextPage = () => {
  return (
    <div className={"px-4 py-16"}>
      ...
      <div>
        <label
          className={"w-full h-48 flex items-center justify-center border-2 border-dashed border-gray-300 rounded-md " +
            "text-gray-600 hover:text-orange-500 hover:border-orange-500 cursor-pointer"}>
          <svg
            className="h-12 w-12"
            stroke="currentColor"
            fill="none"
      ...
      <button
        className={"mt-4 w-full bg-orange-500 hover:bg-orange-600 text-white py-2 px-4 border border-transparent " +
          "rounded-md shadow-sm text-sm font-medium focus:ring-2 focus:ring-offset-2 focus:ring-orange-500 focus:outline-none"}>Upload
        product
      </button>
    </div>
  );
